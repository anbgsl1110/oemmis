...
define([
    ...
    function(angular, _, $) {
        return angular.module("Common.services", ['ngResource'])
                ...
                '$rootScope', function($rootScope) {
                    ...
                    function openWindow(name) {
                        ...
                        var new_window = window.open('about:blank',
                            name,
                            'location=no,hotkeys=no,menubar=no,scrollbars=yes,titlebar=no,toolbar=no,height=' +
                            height +
                            ',width=' +
                            width +
                            '');
            ...
            .factory('singleHttpFactory',
            [
                'httpRequestWapper', 'singlePromiseWapper', function(httpRequestWapper, singlePromiseWapper) {
                    return {
                        /**
                         * description:
            ...
            .factory('dynamicDirectiveService',
            [
            ...
            .factory('singleThreadedNetService',
            [
                function() {
                    return function(fn) {
