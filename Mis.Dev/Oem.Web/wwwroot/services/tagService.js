...
define(['angular'],
    function(angular) {
        return angular.module("Tag.services", [])
            ...
            .service('tagNetService',
            [
                'TAG_TREE_ENUM', '$http', '$q', function(TAG_TREE_ENUM, $http, $q) {
            ...
            [
                'tagTreeService', 'TAG_TYPE_ENUM', function(tagTreeService, TAG_TYPE_ENUM) {
                    return {
