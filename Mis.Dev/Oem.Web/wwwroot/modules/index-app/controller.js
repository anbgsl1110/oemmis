                   ...
                   //销售统计数据渲染
                    ...
                    $scope.donutDataUi = function(partName, schoolName) {
                        ...
                        indexService.getDonutData(request).then(function(result) {
                            ...
                            Highcharts.setOptions({
                                colors: [
                                    '#6c7f9c', '#ff9b0c', '#72d07b', '#60b9f1', '#667fec', '#ae79e5', '#e876c4',
                                    '#c95f46',
                                    '#64dbda', '#f2d23d'
                                ]
                            });
                                    ...
                                    if (fixedIsNAN > 0) {
                                        if (result.data.data.validChannel.statistics[i].count > 0) {
                                            $scope.validChanneldata.push({
                                                ...
                                                y: parseFloat((result.data.data.validChannel.statistics[i].count /
                                                    $scope.validChannelCount *
                                                    100).toFixed(2)),
                                    ...
                                    if (fixedIsNAN > 0) {
                                        if (result.data.data.signChannel.statistics[i].count > 0) {
                                            ...
                                            $scope.signChanneldata.push({
                                                ...
                                                y: parseFloat((result.data.data.signChannel.statistics[i].count /
                                                    $scope.signChannelCount *
                                                    100).toFixed(2)),
                                                color: currentColor
                                            });
                    ...
                    $scope.funnelUiData = function() {
                        ...
                        chart = new Highcharts.Chart({
                            ...
                            plotOptions: {
                                series: {
                                    dataLabels: {
                                        ...
                                        enabled: true,
                                        format:
                                            '<b style="font-size: 12px; color: #444; font-family: Microsoft Yahei,Helvetica Neue,Helvetica,Arial,sans-serif; font-weight: normal;">{point.name}</b> ' +
                            ...
                            series: [
                                {
                                    name:
                                        '<span style="font-size: 12px; color: #444; font-family: Microsoft Yahei,Helvetica Neue,Helvetica,Arial,sans-serif; font-weight: normal;">共计</span>',
                                    data: [
                                        [
                                            '<span style="font-size: 12px; color: #444; font-family: Microsoft Yahei,Helvetica Neue,Helvetica,Arial,sans-serif; font-weight: normal;">线索总数</span>',
                                            $scope.funnel_allSell
                                        ],
                                        [
                                            '<span style="font-size: 12px; color: #444; font-family: Microsoft Yahei,Helvetica Neue,Helvetica,Arial,sans-serif; font-weight: normal;">有效线索</span>',
                                            $scope.funnel_effectSell
                                        ],
                                        [
                                            '<span style="font-size: 12px; color: #444; font-family: Microsoft Yahei,Helvetica Neue,Helvetica,Arial,sans-serif; font-weight: normal;">跟进线索</span>',
                                            $scope.funnel_followSell
                                        ],
                                        [
                                            '<span style="font-size: 12px; color: #444; font-family: Microsoft Yahei,Helvetica Neue,Helvetica,Arial,sans-serif; font-weight: normal;">到访线索</span>',
                                            $scope.funnel_visitSell
                                        ],
                                        [
                                            '<span style="font-size: 12px; color: #444; font-family: Microsoft Yahei,Helvetica Neue,Helvetica,Arial,sans-serif; font-weight: normal;">签约线索</span>',
                                            $scope.funnel_signingSell
                                        ]
                                    ]
                                }
                            ]
                        ...
                        chart = new Highcharts.Chart({
                            ...
                            yAxis: [
                                { // Secondary yAxis
                                    ...
                                    title: {
                                        text:
                                            '<span style="font-size: 12px; color: #444; font-family: Microsoft Yahei,Helvetica Neue,Helvetica,Arial,sans-serif;">签约数</span>',
                                        align: 'high',
                                        offset: 0,
                                        rotation: 0,
                                        y: -15,
                                ...
                                { // Tertiary yAxis
                                    ...
                                    title: {
                                        text:
                                            '<span style="font-size: 12px; color: #444; font-family: Microsoft Yahei,Helvetica Neue,Helvetica,Arial,sans-serif;">销售额(千)</span>',
                                        align: 'high',
                                        offset: 0,
                                        rotation: 0,
                                        y: -15,
                            ...
                            series: [
                                {
                                    name:
                                        '<span style="font-size: 12px; color: #444;font-family: Microsoft Yahei,Helvetica Neue,Helvetica,Arial,sans-serif; font-weight: normal;">签约数</span>',
                                    type: 'column',
                                    yAxis: 0,
                                    useHTML: true,
                                    ...
                                    name:
                                        '<span style="font-size: 12px; color: #444; font-family: Microsoft Yahei,Helvetica Neue,Helvetica,Arial,sans-serif; font-weight: normal;">销售额(千)</span>',
                                    type: 'line',
                                    yAxis: 1,
                                    useHTML: true,
                                    fontWeight: 'normal',
                    ...
                    $scope.donutUiData = function() {
                        ...
                        chart = new Highcharts.Chart({
                            ...
                            title: {
                                text:
                                    '<span style="font-size: 24px; color: #444; font-family: Microsoft Yahei,Helvetica Neue,Helvetica,Arial,sans-serif;">' +
                                        $scope.validChannelCount +
                                        '</span> ',
                            ...
                            series: [
                                {
                                    name:
                                        '<span style="font-size: 12px; color: #444; font-family: Microsoft Yahei,Helvetica Neue,Helvetica,Arial,sans-serif;">共计</span>',
                    ...
                    $scope.donutUiData3 = function() {
                        chart = new Highcharts.Chart({
                            ...
                            title: {
                                text:
                                    '<span style="font-size: 24px; color: #444;  width:80%; font-family: Microsoft Yahei,Helvetica Neue,Helvetica,Arial,sans-serif;">' +
                                        $scope.salesChannelCount +
                                        '</span> ',
                                verticalAlign: 'middle',
                                y: -4,
